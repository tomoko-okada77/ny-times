...
const Card = ({ article }: Props) => {
  return (
    ...
    >
      <figure className="w-full h-auto min-w-[112px] aspect-[112/75] bg-gray-300 overflow-hidden flex items-center justify-center relative">
      ...
      <div>
        <h3 className="text-lg font-bold mb-3">{article.headline.main}</h3>
